...
export function InquiryPage() {
  ...
  const submit = async (event) => {
    ...
    if (Object.keys(nextErrors).length) { setErrors(nextErrors); setStatus("invalid"); return; }
    setStatus("sending");
    try {
